...
if (localStorage != 0) {
  document.getElementById("availRecords").innerHTML = "<br> Records available in Local Storage"
}
...
btnDelete.onclick = function () {
  const inputDelKeyNew = inputDelKey.value;

  if(inputDelKeyNew){
    localStorage.removeItem(inputDelKeyNew)
    window.location.reload()
  }
